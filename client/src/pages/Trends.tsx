  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <Card className="border border-[#C8DDD0] overflow-hidden" shadow="none">
        <CardHeader className="bg-[#003D2B] px-4 sm:px-6 py-4">
          <div>
        ...
        <CardBody className="p-2 sm:p-6">
          <ResponsiveContainer width="100%" height={320}>
            <LineChart data={data} margin={{ top: 10, right: 8, bottom: 8, left: -10 }}>
              <CartesianGrid strokeDasharray="3 3" stroke="#E8F5EE" />
              <XAxis
                dataKey="label"
                tick={{ fontSize: 10, fontFamily: '"Geist Mono", ui-monospace, monospace' }}
                interval="preserveStartEnd"
              />
              <YAxis tick={{ fontSize: 10, fontFamily: '"Geist Mono", ui-monospace, monospace' }} width={36} />
              <Tooltip />
              <Legend wrapperStyle={{ fontSize: 12, paddingTop: 8 }} />
              <ReferenceLine y={0} stroke="#C8DDD0" strokeWidth={1.5} />
              <Line type="monotone" dataKey="Tee"        stroke="#2563eb" strokeWidth={2} dot={{ r: 3 }} />
              <Line type="monotone" dataKey="Approach"   stroke="#16a34a" strokeWidth={2} dot={{ r: 3 }} />
              <Line type="monotone" dataKey="Short Game" stroke="#d97706" strokeWidth={2} dot={{ r: 3 }} />
              <Line type="monotone" dataKey="Putting"    stroke="#dc2626" strokeWidth={2} dot={{ r: 3 }} />
              <Line type="monotone" dataKey="Total"      stroke="#003D2B" strokeWidth={3} dot={{ r: 4 }} />
            </LineChart>
          </ResponsiveContainer>
        </CardBody>
      </Card>
